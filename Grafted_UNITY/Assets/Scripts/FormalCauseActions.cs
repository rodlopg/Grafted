...
public class FormalCauseActions : MonoBehaviour, IDamageable {
    ...
    public void death() {
        ...
        SoundManager.Instance.changeMusic(finalMusic);
        Destroy(gameObject);
    }

    // Shoot the falling soear projectile
    private void projectileAttack() {
        ...
        // Set the target X position (snapshot)
        float playerX = playerTransform.position.x;
        projectile.GetComponent <FallingSpearLogic>().SetTargetX(playerX);
    }
}